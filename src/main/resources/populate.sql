...
(5, 'BBVA', '$2a$10$en0dAnBZn.gHxE1lZm5dS.wJ2h8ArJqF7hWN7yoMvSYAwoa2y/9LC', 'THIRD_PARTY', '$2a$10$en0dAnBZn.gHxE1lZm5dS.wJ2h8ArJqF7hWN7yoMvSYAwoa2y/9LC');
INSERT INTO third_party (id, name, password, role, hashed_key) VALUES
(6, 'Sabadell', '$2a$10$en0dAnBZn.gHxE1lZm5dS.wJ2h8ArJqF7hWN7yoMvSYAwoa2y/9LC', 'THIRD_PARTY', '$2a$10$en0dAnBZn.gHxE1lZm5dS.wJ2h8ArJqF7hWN7yoMvSYAwoa2y/9LC');
...
('1', 'CREDIT_CARD_ACCOUNT', '900.00', 'USD', '2020-06-24', '40.00', '$2a$10$en0dAnBZn.gHxE1lZm5dS.wJ2h8ArJqF7hWN7yoMvSYAwoa2y/9LC', 'ACTIVE', '2020-06-24', '3', '100.00', '0.20', 10);

INSERT INTO credit_card_account (id, account_type, amount, currency, created_at, penalty_fee, secret_key, status, updated_at, primary_owner, credit_limit, interest_rate, max_transactions24hrs) VALUES
('2', 'CREDIT_CARD_ACCOUNT', '400.00', 'USD', '2020-06-24', '40.00', '$2a$10$en0dAnBZn.gHxE1lZm5dS.wJ2h8ArJqF7hWN7yoMvSYAwoa2y/9LC', 'ACTIVE', '2020-06-24', '4', '100.00', '0.20', 10);
...
('3', 'CHECKING_ACCOUNT', '360.00', 'USD', '2020-06-24', '40.00', '$2a$10$en0dAnBZn.gHxE1lZm5dS.wJ2h8ArJqF7hWN7yoMvSYAwoa2y/9LC', 'ACTIVE', '2020-06-24', '3', '250.00', '12.00', 10);
...
('4', 'STUDENT_CHECKING_ACCOUNT', '360.00', 'USD', '2020-06-24', '40.00', '$2a$10$en0dAnBZn.gHxE1lZm5dS.wJ2h8ArJqF7hWN7yoMvSYAwoa2y/9LC', 'ACTIVE', '2020-06-24', '4', 10);
...
('5', 'SAVINGS_ACCOUNT', '400.00', 'USD', '2020-06-24', '40.00', '$2a$10$en0dAnBZn.gHxE1lZm5dS.wJ2h8ArJqF7hWN7yoMvSYAwoa2y/9LC', 'ACTIVE', '2020-06-24', '3', '0.0025', '1000.00', 10);

INSERT INTO savings_account (id, account_type, amount, currency, created_at, penalty_fee, secret_key, status, updated_at, primary_owner, interest_rate, minimum_balance, max_transactions24hrs) VALUES
('6', 'SAVINGS_ACCOUNT', '400.00', 'USD', '2020-06-24', '40.00', '$2a$10$en0dAnBZn.gHxE1lZm5dS.wJ2h8ArJqF7hWN7yoMvSYAwoa2y/9LC', 'ACTIVE', '2020-06-24', '4', '0.0025', '1000.00', 10);